...
var characters = ['Papyrus', 'Sans', 'CyberLegends', 'Undyne', 'Alphys', 'Mettaton', 'Chara'];
...
function main_pallete() {
  ...
  const outputPath =
    'C:\\Users\\emers\\Desktop\\Coding projects\\Python Bot\\ToonBoom_Automations\\output.json';
